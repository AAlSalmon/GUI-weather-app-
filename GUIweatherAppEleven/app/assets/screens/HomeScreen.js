...
function HomeScreen({navigation, route}) {
    ...
    return (
        <ImageBackground source={require('../../../app/assets/HomeScreenBackground.jpeg')} style={styles.containter}> 
        {
            data && fifDayData ? <ImageBackground source={require('../../../app/assets/HomeScreenBackground.jpeg')} style={styles.containter}>
                             ...
                             return (
                                 <TouchableOpacity style={styles.DaysBox}key = {item.key}  onPress={ () => navigation.navigate("DetailedView",{temp:fifDayData.list[j+15].temp.day, icon: fifDayData.list[j+15].weather[0].main, weatherDesc: fifDayData.list[j+15].weather[0].description, humidity: fifDayData.list[j+15].humidity}) }>
                                     <Text > 
                                        ...
                                        {
                                            fifDayData.list[j+15].weather[0].main == "Clouds" ? <View style={styles.testBox1View}><Image style={styles.ImageBoxTEST} source={require('../../../app/assets/Clouds.png')}/></View>
                                                :
                                            fifDayData.list[j+15].weather[0].main == "Rain" ? <View style={styles.testBox1View}><Image style={styles.ImageBoxTEST} source={require('../../../app/assets/Rain.png')}/></View>
                                                : 
                                            fifDayData.list[j+15].weather[0].main == "Clear" ? <View style={styles.testBox1View}><Image style={styles.ImageBoxTEST} source={require('../../../app/assets/Clouds.png')}/></View> : null
                                        } 
                                     </Text>
                                 </TouchableOpacity>
                             )
